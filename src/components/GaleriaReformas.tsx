      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {gifCards.map((card, index) => (
            <div
              key={index}
              className={`group relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-xl shadow-2xl cursor-pointer transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 pb-8 sm:pb-12 transition-transform duration-500 ease-out transform translate-y-[calc(100%-80px)] sm:translate-y-[calc(100%-95px)] group-hover:translate-y-0">
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200">
                  ...
                  <p className="text-sm text-white/90 leading-relaxed font-light drop-shadow-md">
                    {card.description}
                  </p>
                </div>
              </div>
